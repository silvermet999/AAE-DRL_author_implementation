...
# 2/ we generate labels using TabNet for the data generated by the decoder -> we trained the DRL algorithm
# 3/ we trained the AAE on augmented dataset -> performed benchmark classification using the dataset generated by the augmented decoder and the labels generated earlier by the classifier plus original labels
