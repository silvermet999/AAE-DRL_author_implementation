...
def parse_args(args):
    ...
    parser.add_argument("--loss_threshold", default=0.9, type=int)
    ...
    parser.add_argument("--dataset_file", default="ds_file.csv")
    # PLEASE USE THE ABSOLUTE PATH IF YOU GET A NO FILE IS FOUND!!!
    parser.add_argument("--save_state_dict", default="/home/silver/PycharmProjects/AAEDRL/AAE/aae.pth")
