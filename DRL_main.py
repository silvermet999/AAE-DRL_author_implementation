...
def parse_args(args):
    ...
    parser.add_argument("--dataset_file", default="ds.csv") # synthetic dataset generated by the decoder
    parser.add_argument("--labels_generated", default="/home/silver/PycharmProjects/AAEDRL/clfs/labels.csv") # labels generated for the synthetic data

    
    # save samples and state dictionaries
    parser.add_argument("--rl_dataset", default="/home/silver/PycharmProjects/AAEDRL/DRL/rl_ds.csv") # newly generated dataset
    parser.add_argument("--actor_path", default = "/home/silver/PycharmProjects/AAEDRL/actor.pth") # actor state dictionary
    parser.add_argument("--critic_path", default = "/home/silver/PycharmProjects/AAEDRL/critic.pth") # critic state dictionary
